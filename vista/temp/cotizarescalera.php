		          	 ...
		          	 <div class="ocarousel_slider">  
	      				<div class="ocarousel example_photos" data-ocarousel-perscroll="3">
			                <div class="ocarousel_window">
                                        <?php 
                                        $query = "SELECT * FROM escaleras";
                                        $resultado = $conexion ->query($query);
                                        while($row = $resultado->fetch_assoc()){
                                        ?>
                                            <a href="javascript:seleccionar()"><p type="text" name="id"><?php echo $row['id']; ?></p><img style="width:170px; height:170px" src="data:image/jpg;base64,<?php echo base64_encode($row['imagen']); ?>"/><p> <?php echo $row['nombre']; ?> <?php echo $row['alto']; ?> <?php echo $row['ancho']; ?> <?php echo $row['pasos']; ?></p></a>
			                <?php } ?>
                                        </div>
                                        <span>           
