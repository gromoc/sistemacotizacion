<center>
    <a onmouseover="this.style.background='#CECEF6'" onmouseout="this.style.background='white'" class="letrasinicio"> ¿QUE DESEAS COTIZAR?</a>
    <br>
    <br>
    <table style="width: 100%;">
        <tr>
            ...
            <td class="estilopropio1">
                ...
                <br>
                <button class="estilo2" onmouseover="this.style.background='url(../imagenes/metal.png) no-repeat center center'" onmouseover="this.style.constructor=''"
                    onmouseout="this.style.background=' url(../imagenes/metal.png)'">
                    OTROS</button>
                <br>
                <br>
